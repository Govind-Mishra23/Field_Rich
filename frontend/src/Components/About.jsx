...
export const About = () => {
  ...
  return (
    <section
      id="about"
      className="py-16 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-orange-50 to-red-50"
    >
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            ...
            sets us apart in the spice industry.
          </p>
        </motion.div>
        ...
        >
          ...
          <p className="text-gray-500">
            Leading FIELD RICH with passion and dedication to bring you the
            finest spices from nature's bounty.
          </p>
        </motion.div>
      </div>
    </section>
