          ...
          {products.slice(0, 6).map((product, index) => (
            ...
            >
              <motion.div
                ...
                className="bg-gradient-to-br from-amber-50 to-orange-100 rounded-2xl p-6 shadow transition-all duration-300 border border-orange-200 cursor-pointer hover:shadow-lg"
              >
                ...
                <div className="text-center">
                  ...
                  <div className="inline-flex items-center gap-2 text-orange-600 group-hover:text-orange-700 font-semibold transition-colors">
                    View Details{" "}
