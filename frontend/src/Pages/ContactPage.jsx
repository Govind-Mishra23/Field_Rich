        ...
        <div className="max-w-6xl mx-auto">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Ready to experience the authentic taste of Field Rich spices? We'd love to hear from you!
            </p>
          </motion.div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mb-20">
            {contactInfo.map((info, index) => (
              ...
              >
                <div className={`inline-flex items-center justify-center w-16 h-16 bg-gradient-to-br ${info.color} rounded-full mb-6 group-hover:scale-110 transition-transform duration-300`}>
                  <info.icon className="w-8 h-8 text-white" />
                </div>
                <h3 className="text-lg font-semibold text-gray-800 mb-2">{info.title}</h3>
                <p className="text-lg font-medium text-gray-700 mb-1">{info.value}</p>
              ...
              <div className="bg-white rounded-2xl p-8 shadow-xl border border-orange-100">
                ...
                <div className="w-full h-64 bg-gradient-to-br from-orange-100 to-red-100 rounded-lg flex items-center justify-center mb-4">
                  <div className="text-center">
                    ...
                    <p className="text-sm text-gray-500">(Replace with Google Maps)</p>
                  </div>
                </div>
                <p className="text-gray-600 text-center">
                  <strong>Field Rich Spices</strong><br />
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">contact@fieldrichindia.com</p>
                    </div>
                  </div>
                </div>
              </div>
      ...
      <section className="pb-20 px-6">
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Follow us on social media for the latest updates, recipes, and spice tips
            </p>
          </motion.div>
          ...
          <div className="grid md:grid-cols-4 gap-8 mb-16">
            {socialLinks.map((social, index) => (
              ...
              >
                ...
                <h3 className="text-lg font-semibold text-gray-800">{social.label}</h3>
              </motion.div>
            ))}
          </div>
        </div>
            ...
            {[
              {
                ...
                answer: "Our spices are 100% natural, preservative-free, and sourced directly from organic farms across India. We use traditional processing methods to preserve authentic flavor and health benefits."
              },
              {
                question: "Do you ship internationally?",
                answer: "Currently, we ship within India. We're working on expanding our international shipping capabilities. Contact us for bulk orders and special arrangements."
              },
              {
                question: "How long does shipping take?",
                answer: "Standard shipping within India takes 3-5 business days. Express shipping is available for 1-2 business days delivery."
              },
              {
                question: "Can I customize spice blends?",
                answer: "Yes! We offer custom spice blends tailored to your specific needs. Contact us to discuss your requirements and we'll create the perfect blend for you."
              }
            ].map((faq, index) => (
              <motion.div
                key={index}
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            ...
            <p className="text-xl text-gray-600 mb-8">
              Experience the authentic taste of Field Rich spices in your kitchen today
            </p>
